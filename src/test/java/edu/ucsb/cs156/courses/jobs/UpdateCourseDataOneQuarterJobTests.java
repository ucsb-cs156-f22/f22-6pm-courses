...
public class UpdateCourseDataOneQuarterJobTests {
    ...
    void test_log_output_success() throws Exception {
        ...
        UpdateCourseDataOneQuarterJob updateCourseDataOneQuarterJob = new UpdateCourseDataOneQuarterJob("20211", ucsbCurriculumService,
        ...
        updateCourseDataOneQuarterJob.accept(ctx);
