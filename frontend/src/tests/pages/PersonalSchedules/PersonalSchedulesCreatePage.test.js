...
describe("PersonalSchedulesCreatePage tests", () => {
    ...
    test("when you fill in the form and hit submit, it makes a request to the backend", async () => {
        ...
        expect(mockToast).toBeCalledWith("New personalSchedule Created - id: 17 name: ABC");
        expect(mockNavigate).toBeCalledWith({ "to": "/personalschedules/list" });
    });

    test("when you try to store a personal schedule that the pair of the name and the quarter is not unique, you get a reasonable error message and a chance to fix the problem", async () => {
        ...
        expect(mockToast).toBeCalledWith("PersonalSchedule for ABC in S22 already exists");
